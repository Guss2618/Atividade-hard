...
console.log(texto.toUpperCase()); // "APRENDENDO JAVASCRIPT É DIVERTIDO E RECOMPENSADOR!"
...
console.log(textoComHifens); // "Aprendendo-JavaScript-é-divertido-e-recompensador!"
...
console.log(contarOcorrencias("banana", "a")); // 3
